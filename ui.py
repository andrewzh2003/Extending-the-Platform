...
def edit_files():
    ...
    -addpost [NEW POST]
    ** within the addpost there are keywords that you can use.
    - the first keyword is @weather and it will give u a description of the weather at UC Irvine
    - the second keyword is @lastfm and it will tell you how many listeners there are for a particular 
      album in this case it's Bandaids by Keshi
